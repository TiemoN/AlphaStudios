...
public class TankManager1vs1
{
    ...
    private TankShooting1vs1 m_Shooting;
    private GameObject m_CanvasGameObject;

    public void Setup()
    {
        m_Movement = m_Instance.GetComponent<TankMovement1vs1>();
        m_Shooting = m_Instance.GetComponent<TankShooting1vs1>();
